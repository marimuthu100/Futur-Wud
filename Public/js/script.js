(function ($) {
  ...
  if ($(".appointment-tabs").length) {
    $(".appointment-tabs .tab-buttons .p-tab-btn").on("click", function (e) {
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(".appointment-tabs .tab-buttons .p-tab-btn").removeClass(
          "active-btn"
        );
  ...
  if ($(".gallery-tab").length) {
    $(".gallery-tab .product-tab-btns .p-tab-btn").on("click", function (e) {
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(".gallery-tab .product-tab-btns .p-tab-btn").removeClass(
          "active-btn"
        );
        $(this).addClass("active-btn");
  ...
  if ($(".gallery-carousel-two").length) {
    $(".gallery-carousel-two").owlCarousel({
      ...
      autoplay: 5000,
      navText: [
        '<span class="flaticon-left-arrow-2"></span> Prev',
        'Next <span class="flaticon-right-arrow-4"></span>',
      ],
      responsive: {
        0: {
          items: 1,
